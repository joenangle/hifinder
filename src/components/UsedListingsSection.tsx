      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <select
            ...
            className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-colors"
          >
...
{/* Demo Data Warning */}
      {filteredListings.some(listing => listing.url.includes('/sample')) && (
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-700 p-4 rounded-xl mb-4 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-blue-900 dark:text-blue-100 text-sm font-medium mb-1">Demo Data</p>
      ...
      {/* Safety Warning */}
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 border border-yellow-200 dark:border-yellow-700 p-4 rounded-xl mb-6 shadow-sm">
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0 mt-0.5">
      ...
      {filteredListings.length > 0 && (
        <div className="mt-8 p-6 bg-gradient-to-br from-blue-50 via-blue-50 to-cyan-50 dark:from-blue-900/20 dark:via-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-700 rounded-xl shadow-sm">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 mt-1">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-400 dark:to-blue-500 flex items-center justify-center shadow-md">
      ...
      {component.amazon_url && (
        <div className="mt-6 p-6 bg-gradient-to-br from-gray-50 via-gray-50 to-orange-50 dark:from-gray-800/50 dark:via-gray-800/50 dark:to-orange-900/20 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm">
          <div className="text-center">
            <div className="mb-3">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 dark:from-orange-400 dark:to-orange-500 mb-3 shadow-md">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
              </div>
              <p className="text-gray-900 dark:text-gray-100 font-semibold text-lg mb-1">Prefer to buy new?</p>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Get the latest model with full warranty</p>
            </div>
            <a
              href={component.amazon_url}
              target="_blank"
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-3">
              <span className="inline-flex items-center gap-1 bg-gray-100 dark:bg-gray-700/50 px-3 py-1.5 rounded-full">
