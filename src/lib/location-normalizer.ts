/**
 * Location lists for the marketplace filter UI.
 *
 * Note: location string normalization is in scripts/location-normalizer.js
 * (used by Node scrapers). This file is the UI-only subset.
 */
